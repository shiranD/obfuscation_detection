...
import pickle
import numpy as np
from aux_func import acc, overall_acc, align_w_out
import re 
import sys
...
for fold in xrange(num_f):
  ...
  y_hat1 = model1.predict(X_test, verbose=0)
  y_hat2 = model2.predict(X_test, verbose=0)
  y_hat3 = model3.predict(X_test, verbose=0)
  y_hat4 = model4.predict(X_test, verbose=0)
  y_hat5 = model5.predict(X_test, verbose=0)
  y_hat6 = model6.predict(X_test, verbose=0)
  y_hat7 = model7.predict(X_test, verbose=0)
